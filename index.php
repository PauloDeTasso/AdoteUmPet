    ...
    <body>
        ...
        <section class="login-cadastro">
            <p>
                ...
                ou
                <a href="usuario_cadastre_se.php" class="btn">Cadastre-se</a>
            </p>
        </section>
        ...
        <section class="pets-disponiveis">
            ...
            <section>
                ...
                <div>
                    <img src="<?= htmlspecialchars($pet['imagem_pet'] ? $pet['imagem_pet'] : 'imagens/pets/default.jpg'); ?>"
        ...
        <section class="pets-adotados">
            ...
            <ul>
                ...
                <li>
                    <img src="<?php echo htmlspecialchars($pet['imagem_pet'] ? $pet['imagem_pet'] : 'imagens/pets/default.jpg'); ?>"
                        alt="Imagem de <?php echo htmlspecialchars($pet['pet_nome']); ?>"
        ...
        <section class="ultimas-adocoes">
            ...
            <ul>
                ...
                <li>
                    <img src="<?php echo htmlspecialchars($adocao['imagem_pet'] ? $adocao['imagem_pet'] : 'imagens/pets/default.jpg'); ?>"
                    ...
                    <img src="<?php echo htmlspecialchars($adocao['imagem_adotante'] ? $adocao['imagem_adotante'] : 'imagens/usuarios/default.jpg'); ?>"
        ...
        <section class="login-cadastro">
            <p><a href="login.php" class="btn">Entrar</a> ou <a href="usuario_cadastre_se.php"
