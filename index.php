...
<body>
    ...
    <section class="login-cadastro">
        <p><a href="login.php" class="btn">Entrar</a> ou <a href="usuario_cadastrar_se.php" class="btn">Cadastrar-se</a>
        </p>
    </section>
    ...
    <section class="login-cadastro">
        <p><a href="login.php" class="btn">Entrar</a> ou <a href="usuario_cadastrar_se.php" class="btn">Cadastre-se</a>
        </p>
    </section>
