    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="usuario-info">
                ...
                <?php
            // Verifica se há uma imagem registrada, se não houver, define a imagem padrão
            $imagemUsuario = !empty($usuario['imagem']) ? htmlspecialchars($usuario['imagem']) : 'imagens/usuarios/default.jpg';
            ?>
                <img src="<?= $imagemUsuario ?>" alt="Foto de perfil" class="usuario-imagem">
        ...
        document.getElementById('form-senha').addEventListener('submit', function(event) {
            ...
            if (novaSenha.length < 6) {
                ...
                exibirToast('A nova senha deve ter no mínimo 6 caracteres.', 'erro');
                return;
            }
